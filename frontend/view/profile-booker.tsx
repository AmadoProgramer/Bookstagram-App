...
type ProfileBookerScreenNavigationProp = NativeStackNavigationProp<
  RootStackParamList,
  "ProfileBooker"
>;

interface Props {
  navigation: ProfileBookerScreenNavigationProp;
}
...
export default function ProfileBookerScreen({ navigation }: Props) {
  const books: Book[] = [
    {
      id: "1",
      ...
      author: "BestSeller",
      cover:
        "https://images.unsplash.com/photo-1621351183012-e2f3db3a5330?w=300",
      rating: 5,
      genre: "Fantasy",
    },
    {
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.profileSection}>
          ...
          <View style={styles.badgeContainer}>
            ...
            <View style={styles.levelIndicators}>
              {[1, 2, 3, 4, 5, 6].map((level) => (
                <View
                  key={level}
                  style={[styles.levelDot, level <= 4 && styles.levelDotActive]}
                />
              ))}
            </View>
          </View>
          ...
          <Text style={styles.bio}>
            Soy un lector apasionado que le gusta la literatura de economía y
...
const styles = StyleSheet.create({
  ...
  badge: { fontSize: 14, fontWeight: "bold", color: "#000" },
  levelIndicators: {
    flexDirection: "row",
    gap: 5,
  },
